...
void EmptyLinkFunctionForGeneratedCodeBai5_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_Bai5()
	{
		if (!Z_Registration_Info_UPackage__Script_Bai5.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_Bai5_ReceiveDamageDelegate__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_Bai5(Z_Construct_UPackage__Script_Bai5, TEXT("/Script/Bai5"), Z_Registration_Info_UPackage__Script_Bai5, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x06E87A2B, 0x4A7F08D1));
